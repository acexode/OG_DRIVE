...
const Shared = ({location}) => {
    const {fetchUserFolder, removeFile,currUser, sharedFiles, sharedFolders} =  useContext(FileContext)    
            ...
            { isFiles ? <>
                <div className="row mt-5 mb-2">
                 ...
                 <div className="col-md-12 ml-4" style={{marginTop:'8em'}}>
                   <h5 className="text-secondary text-center">No Files has been shared with you </h5> 
                 </div>
